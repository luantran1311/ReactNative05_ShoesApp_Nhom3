...
export const fetchProductsByCategoryId = createAsyncThunk(
    ...
    async (category,{dispatch,getState}) => {
        ...
        const resp = await fetch(`https://shop.cyberlearn.vn/api/Product/getProductByCategory?categoryId=${category.id}`)
        const json = await resp.json()
        return json.content
    }
)
...
export const fetchCategories = createAsyncThunk(
    ...
    async () => {
        ...
        const resp = await fetch('https://shop.cyberlearn.vn/api/Product/getAllCategory')
        const json = await resp.json()
        return json.content
    }
)