...
import {faXmark, faSliders, faHeart} from '@fortawesome/free-solid-svg-icons';
  ...
  if (productList && productList.length > 0) {
    ...
    return (
      <View style={{flex: 1, justifyContent:'center', alignItems:'center'}}>
        <Text style={{color: COLORS.primaryColor, fontFamily: FONTS.boldFont, fontSize: FONTS.h5}}>No products to display.</Text>
      </View>
    )
  }
}
