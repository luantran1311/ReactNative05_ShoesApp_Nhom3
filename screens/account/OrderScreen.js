  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.order__status__wrapper}>
        <TouchableOpacity style={styles.btn} onPress={() => console.log('order status pressed')}>
        ...
        <TouchableOpacity style={[styles.btn,styles.no__border]} onPress={() => console.log('order status pressed')}>
