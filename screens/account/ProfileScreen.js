...
export default function ProfileScreen() {
  ...
  return (
    <View style={styles.container}>
      {/* header */}
      <AccountHeader screenTitle={'My Profile'} />
      ...
      <View style={styles.wrapper}>
        <View style={styles.form__wrapper}>
          ...
          <View style={styles.form__input}>
            <FontAwesomeIcon style={styles.form__input__icon} icon={faPhone} />
            <TextInput
              style={styles.form__input__text}
        ...
        <View style={styles.account__actions}>
          <TouchableOpacity
            ...
            <Text style={[styles.btn__text, styles.btn__text]}>Update</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
